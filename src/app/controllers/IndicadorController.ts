...
export class IndicadorController {
  ...
  public async buscarTodosIndicadores() {
    return this.indicadorService.buscarTodosIndicadores();
  }
  /*
    ...
    async listarIndicadores(request: NextApiRequest, response: NextApiResponse) {
      try {
